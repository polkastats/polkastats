...
const ethereumHoldersAddresses = ["0x88E3386AC317892782f346e65FA7a4dd893552a1", "0x367ebF942F75E0c7Cf3EC0CEe1017349EDb3368b",
  ...
  "0xAC114DA1B620FeD209bA4a11D46Dfb6A17641825"];
...
module.exports = {
  ...
  getCirculatingSupply: async (req, res) => {
    ...
    for (let i = 0; i < ethereumHoldersAddresses.length; i++) {
      const balance = await ethNetworkService.getCEREBalanceOf(ethereumHoldersAddresses[i]);
