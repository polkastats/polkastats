...
export default {
  ...
  data() {
    return {
	  chart: new ChartLineOptions('era', this.$t('components.dashboard_performance.avg_performance')),
      config,
    //   chartOptions: {
    //     responsive: true,
    ...
    $subscribe: {
      ...
      era_relative_performance_avg: {
        ...
        //   }
		 	...
		 	this.chart.setData(this.rows.map((row) => row.relative_performance_avg));
